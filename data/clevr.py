...
def main(tfrecord_path, data_path):
    ...
    ds = dataset(join(tfrecord_path, "clevr_with_masks_train.tfrecords"))
    ...
    shapes_train, colors_train, materials_train = [], [], []
    shapes_test, colors_test, materials_test = [], [], []
    for i, sample in enumerate(ds):
        if i < train_thresh:
            ...
            materials_train.append(sample["material"].numpy())
