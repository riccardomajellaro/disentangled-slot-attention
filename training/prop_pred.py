...
parser.add_argument('--disa_ckpt', default=None, type=str, help='checkpoint of DISA')
parser.add_argument('--disa_ckpt_path', default='checkpoints/tetrominoes/', type=str, help='where to save models' )
parser.add_argument('--proppred_ckpt_path', default='checkpoints/tetrominoes/', type=str, help='where to save models')
